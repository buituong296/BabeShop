                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="file" name="image" class="form-control pt-4" id="image"
                                    style="height: 90px">
                                @if ($product->image)
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="Product Image"
                                        class="img-thumbnail" style="width: 30%; height: auto;">
                                @endif
                            </div>
                                    ...
                                    @foreach ($product->album as $image)
                                        <div class="col-md-4 mb-3">
                                            <img src="{{ asset('storage/albums/' . $image->image) }}" alt="Ảnh album"
                                                class="mx-1 rounded-3 img-thumbnail" width="100%">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <input type="file" class="form-control pt-4" style="height: 90px" name="album[]"
                                    multiple>
                            </div>
                        </div>
                            ...
                            <div class="variant-row mb-3">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" name="variants[{{ $index }}][list_price]"
                                            class="form-control" value="{{ $variant->list_price }}" required>
                                    </div>
                                    <div class="col">
                                        <label for="sale_price" class="form-label">Giá Bán</label>
                                        <input type="number" name="variants[{{ $index }}][sale_price]"
                                            class="form-control" value="{{ $variant->sale_price }}" required>
                                    </div>
                                    <div class="col">
                                        <label for="import_price" class="form-label">Giá Nhập</label>
                                        <input type="number" name="variants[{{ $index }}][import_price]"
                                            class="form-control" value="{{ $variant->import_price }}" required>
                                    </div>
                                    <div class="col">
                                        <button type="button" class="btn btn-danger remove-variant"
                                            style="margin-top: 32px;">Xóa</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
