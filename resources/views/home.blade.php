                  ...
                  <div class="swiper px-5 pe-xl-0 ps-xxl-0 me-xl-n5" data-swiper="{
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide text-center text-xl-start pt-5 py-xl-5">
                        <p class="text-body">Cảm nhận âm thanh chất lượng thật</p>
                        <h2 class="display-4 pb-2 pb-xl-4">Tai nghe ProMax</h2>
                      ...
                      <div class="swiper-slide text-center text-xl-start pt-5 py-xl-5">
                        <p class="text-body">Khuyến mãi trong tuần</p>
                        <h2 class="display-4 pb-2 pb-xl-4">iPad Pro M2 mạnh mẽ</h2>
                        <a class="btn btn-lg btn-primary" href="shop-product-general-electronics.html">
                          Mua ngay
                          <i class="ci-arrow-up-right fs-lg ms-2 me-n1"></i>
                        </a>
                      ...
                      <div class="swiper-slide text-center text-xl-start pt-5 py-xl-5">
                        ...
                        <h2 class="display-4 pb-2 pb-xl-4">Trải nghiệm thực tế mới</h2>
                ...
                <div class="col-9 col-sm-7 col-md-6 col-lg-5 col-xl-7">
                  ...
                  <div class="swiper user-select-none" id="sliderImages" data-swiper="{
                    ...
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide d-flex justify-content-end">
                        <div class="ratio rtl-flip" style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                          <img src="assets/img/home/electronics/hero-slider/02.png" alt="Hình ảnh">
                        </div>
                      </div>
                      <div class="swiper-slide d-flex justify-content-end">
                        <div class="ratio rtl-flip" style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                          <img src="assets/img/home/electronics/hero-slider/03.png" alt="Hình ảnh">
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-bs-theme="dark">
            <div class="d-flex flex-column align-items-center justify-content-end h-100 text-center overflow-hidden rounded-5 px-4 px-lg-3 pt-4 pb-5" style="background: #1d2c41 url(assets/img/home/electronics/banner/backgroundbabel.png) center/cover no-repeat">
              ...
              <p class=" text text-bg-light fw-medium mb-4 text-shadow">Texas the Omertosa & Lunacub</p>
          ...
          <div class="col-sm-6 col-lg-4 d-flex flex-column gap-3 pt-4 py-lg-4">
            ...
            <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
              <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                <img src="{{ asset('storage/' . $product->image) }}" alt="Đồng hồ thông minh" href="{{ route('productdetail', $product->id) }}">
              </div>
            ...
            <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
              <div class="position-relative">
                ...
                <div class="dropdown d-lg-none position-absolute top-0 end-0 z-2 mt-2 me-2">
                  <button type="button" class="btn btn-icon btn-sm btn-secondary bg-body" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Thao tác khác">
                ...
                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                  ...
                  <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                    <img src="assets/img/shop/electronics/01.png" alt="Kính thực tế ảo VR">
                  </div>
                </a>
              </div>
              <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                ...
                <h3 class="pb-1 mb-2">
                  <a class="d-block fs-sm fw-medium text-truncate" href="shop-product-general-electronics.html">
                    <span class="animate-target">Kính Thực Tế Ảo VRB01</span>
                  </a>
                </h3>
                <div class="d-flex align-items-center justify-content-between">
                  <div class="h5 lh-1 mb-0">340.99 USD <del class="text-body-tertiary fs-sm fw-normal">430.00 USD</del></div>
    ...
    <section class="container pt-5 mt-sm-2 mt-md-3 mt-lg-4">
              ...
              <div class="row align-items-center position-relative z-2">
                <div class="col-md-6 mb-3 mb-md-0">
                  <div class="text-center text-md-start py-md-5 px-4 ps-md-5 pe-md-0 me-md-n5">
                    ...
                    <p class="text-body-emphasis ps-xxl-3 mb-0">Sử dụng mã <span class="d-inline-block fw-semibold bg-white text-dark rounded-pill py-1 px-2">Sale 2024</span> để nhận ưu đãi tốt nhất</p>
                  </div>
                </div>
                <div class="col-md-6 d-flex justify-content-center justify-content-md-end pb-5 pb-md-0">
                  <div class="me-xxl-4">
                    <img src="assets/img/home/electronics/banner/camera.png" class="d-block rtl-flip" width="420" alt="Máy ảnh">
      ...
      <section class="container pt-5 mt-2 mt-sm-3 mt-lg-4">
        ...
        <div class="position-relative mx-md-1">
          ...
          <button type="button" class="offers-prev btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-start position-absolute top-50 start-0 z-2 translate-middle-y ms-n1 d-none d-sm-inline-flex" aria-label="Trước">
            <i class="ci-chevron-left fs-lg animate-target"></i>
          </button>
          <button type="button" class="offers-next btn btn-icon btn-outline-secondary bg-body rounded-circle animate-slide-end position-absolute top-50 end-0 z-2 translate-middle-y me-n1 d-none d-sm-inline-flex" aria-label="Sau">
              ...
              <div class="swiper-slide">
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                  <div class="position-relative">
                    ...
                    <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-general-electronics.html">
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                        <img src="assets/img/shop/electronics/09.png" alt="Tai nghe không dây">
                      </div>
                    </a>
                  </div>
                  <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                    ...
                    <h3 class="product-title fs-sm">
                      <a class="text-body-emphasis text-truncate" href="shop-product-general-electronics.html">Tai nghe không dây</a>
                    </h3>
                    <div class="d-flex align-items-center flex-wrap gap-2">
                      <span class="h6 text-accent mb-0">1.700.000 ₫</span>
                      <span class="text-body-tertiary text-decoration-line-through fs-sm me-2">2.500.000 ₫</span>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section class="bg-body-tertiary py-5">
        ...
        <div class="row">
            ...
            <ul class="list-unstyled d-flex flex-column gap-4 ps-md-4 ps-lg-0 mb-3">
                ...
                <img src="assets/img/home/electronics/vlog/01.jpg" class="rounded" width="140" alt="Ảnh video">
                <div class="ps-3">
                    <div class="fs-xs text-body-secondary lh-sm mb-2">6:16</div>
                    <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">5 Tiện ích mới bạn phải xem trên Cartzilla - Ngân sách rẻ</a>
                </div>
                </li>
                <li class="nav flex-nowrap align-items-center position-relative">
                <img src="assets/img/home/electronics/vlog/02.jpg" class="rounded" width="140" alt="Ảnh video">
                <div class="ps-3">
                    <div class="fs-xs text-body-secondary lh-sm mb-2">10:20</div>
                    <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">5 Tiện ích siêu hữu ích trên Cartzilla bạn phải có trong 2023</a>
                </div>
                </li>
                <li class="nav flex-nowrap align-items-center position-relative">
                <img src="assets/img/home/electronics/vlog/03.jpg" class="rounded" width="140" alt="Ảnh video">
                <div class="ps-3">
                    <div class="fs-xs text-body-secondary lh-sm mb-2">8:40</div>
                    <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">Top 5 tiện ích mới tuyệt vời trên Cartzilla bạn phải xem</a>
                </div>
                </li>
            </ul>
